...
typedef void cdecklink_video_buffer_allocator_t;
typedef void cdecklink_video_buffer_allocator_provider_t;
typedef void cdecklink_iterator_t;
typedef void cdecklink_api_information_t;
typedef void cdecklink_ip_flow_attributes_t;
typedef void cdecklink_ip_flow_status_t;
typedef void cdecklink_ip_flow_setting_t;
typedef void cdecklink_ip_flow_t;
typedef void cdecklink_ip_flow_iterator_t;
typedef void cdecklink_output_t;
typedef void cdecklink_input_t;
typedef void cdecklink_ip_extensions_t;
typedef void cdecklink_hdmi_input_edid_t;
typedef void cdecklink_encoder_input_t;
typedef void cdecklink_video_buffer_t;
...
typedef void cdecklink_video_frame_mutable_metadata_extensions_t;
